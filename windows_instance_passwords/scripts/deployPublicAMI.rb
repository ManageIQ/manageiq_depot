# 
# Program: deployPublicAMI.rb
# Description: Deploy a public AMI that is not imported into your AWS account.
#              Can be useful to avoid licensing issues with Windows.
