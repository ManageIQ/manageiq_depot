...
begin
  ...
  #########  JD: 20140311
  #  To make the miq_ code more universal, moved IPAM DB naming code to the CustomizeRequest.
  ...
  case env
    when "dev"
      ...
      IPAM_name = "ipam_mgr_10_111_111_0"
      IPAM_name2 = "ipam_mgr_10_222_222_0"
    when "qa"
      default_folder = "ManageIQ/lab/qa"
      IPAM_name = "ipam_mgr_10_111_112_0"
      IPAM_name2 = "ipam_mgr_10_222_223_0"
  end

  IPAM_Source = "ip_mgr_manheim_prod"
  prov.add_tag(:ipam_source, IPAM_Source)
  log(:info, "Tag ipam_source: #{IPAM_Source}")
