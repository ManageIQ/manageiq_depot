...
subject = "[#{vm.name}] - Your virtual machine request has completed this step : ExportVM"

body = "Hello, "

# VM Migration Email Body
body += "<br><br>Your request to migrate virtual machine #{vm.name} has completed this step : ExportVM on #{Time.now.strftime('%A, %B %d, %Y at %I:%M%p')}."
