...
#
# Events: VmMigrateTask_ImportInstance
# Model Notes:
...
subject = "[#{vm.name}] - Your virtual machine request has completed this step : ImportInstance"

body = "Hello, "

# VM Migration Email Body
body += "<br><br>Your request to migrate virtual machine #{vm.name} has completed this step : ImportInstance on #{Time.now.strftime('%A, %B %d, %Y at %I:%M%p')}."
