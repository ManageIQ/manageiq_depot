...
# Set the default appliance IP Address below
appliance = nil
appliance ||= 'cloudlink.jcdecaux.com'
...
body += "<br><br>If you are not already logged in, you can access and manage your virtual machine here <a href='https://#{appliance}/vm/show/#{vm['id']}'>https://#{appliance}/vm/show/#{vm['id']}</a>"
